  ...
  const baseFeatures = [
    {
      id: 'time-tracking',
      title: 'Time tracking',
      subtitle: 'Reliable reporting.',
      description: 'Reports per project, client, user, etc.',
      details: 'Direct integration with invoicing tools.',
      image: '/img/product-shot.png',
      screenshot: '/img/product-shot.png'
    },
    {
      id: 'collaboration',
      title: 'Collaboration', 
      subtitle: 'Fewer emails and meetings.',
      description: 'Quick feedback loops.',
      details: 'Uncomplicated coordination.',
      image: '/img/product-shot.png',
      screenshot: '/img/product-shot.png'
    },
    {
